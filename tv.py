...
class Miseajourtv(models.Model):
    ...
    def modif_dayforgrp(self):
        ...
        dayforgrp = self.env.cr.execute("UPDATE public.brute_tele SET dayforgrp = dayofdatetv WHERE brute_radio.dayofdatetv = 'samedi'")
        dayforgrp = self.env.cr.execute("UPDATE public.brute_tele SET dayforgrp = dayofdatetv WHERE brute_radio.dayofdatetv = 'dimanche'")